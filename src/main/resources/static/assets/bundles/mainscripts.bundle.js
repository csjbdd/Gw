...
$.AdminAero= {}
    ...
    $.AdminAero.options= {
        colors: {
            red: "#ec3b57", pink:"#E91E63", purple:"#ba3bd0", deepPurple:"#673AB7", indigo:"#3F51B5", blue:"#2196f3", lightBlue:"#03A9F4", cyan:"#00bcd4", green:"#4CAF50", lightGreen:"#8BC34A", yellow:"#ffe821", orange:"#FF9800", deepOrange:"#f83600", grey:"#9E9E9E", blueGrey:"#607D8B", black:"#000000", blush:"#dd5e89", white:"#ffffff"
        }

        ,
        leftSideBar: {
            scrollColor: "rgba(0,0,0,0.5)", scrollWidth:"4px", scrollAlwaysVisible: !1, scrollBorderRadius:"0", scrollRailBorderRadius:"0"
        }
    ...
    $.AdminAero.leftSideBar= {
        activate:function() {
            ...
            $(window).on("click", function(e) {
                var a=$(e.target); "i"===e.target.nodeName.toLowerCase()&&(a=$(e.target).parent()),  !a.hasClass("bars")&&r.isOpen()&&0===a.parents("#leftsidebar").length&&(a.hasClass("js-right-sidebar")||i.fadeOut(), t.removeClass("overlay-open"))
                ...
                $.each($(".menu .list li.active"), function(e, a) {
                    var r=$(a).find("a:eq(0)"); r.addClass("toggled"), r.next().show()

                }),
                $(".menu-toggle").on("click", function(e) {
                    var a=$(this), r=a.next(); if($(a.parents("ul")[0]).hasClass("list")) {
                        var t=$(e.target).hasClass("menu-toggle")?e.target:$(e.target).parents(".menu-toggle"); $.each($(".menu-toggle.toggled").not(t).next(), function(e, a) {
    ...
    $.AdminAero.rightSideBar= {
        activate:function() {
            ...
            $(window).on("click", function(e) {
                var a=$(e.target); "i"===e.target.nodeName.toLowerCase()&&(a=$(e.target).parent()),  !a.hasClass("js-right-sidebar")&&r.isOpen()&&0===a.parents("#rightsidebar").length&&(a.hasClass("bars")||i.fadeOut(), t.removeClass("open"))
        ...
        activate:function() {
            ...
            $(".bars").on("click", function() {
                ...
                $('.nav [data-close="true"]').on("click", function() {
                    var e=$(".navbar-toggle").is(":visible"), a=$(".navbar-collapse"); e&&a.slideUp(function() {
...
function skinChanger() {
    $(".right-sidebar .choose-skin li").on("click", function() {
        var e=$("body"), a=$(this), r=$(".right-sidebar .choose-skin li.active").data("theme"); $(".right-sidebar .choose-skin li").removeClass("active"), e.removeClass("theme-" +r), a.addClass("active"), e.addClass("theme-" +a.data("theme"))
    })
}

function CustomScrollbar() {
    $(".sidebar .menu .list").slimscroll({
        height:"calc(100vh - 65px)", color:"#eeeeee", position:"right", size:"1px", alwaysVisible: !1, borderRadius:"3px", railBorderRadius:"0"

    }),
        $(".navbar-right .dropdown-menu .body").slimscroll({
            height:"330px", color:"rgba(0,0,0,0.2)", size:"3px", alwaysVisible: !1, borderRadius:"3px", railBorderRadius:"0"

        }),
        $(".chat-widget").slimscroll({
            height:"310px", color:"rgba(0,0,0,0.4)", size:"2px", alwaysVisible: !1, borderRadius:"3px", railBorderRadius:"2px"

        }),
        $(".right-sidebar .slim_scroll").slimscroll({
            height:"calc(100vh - 70px)", color:"rgba(0,0,0,0.4)", size:"2px", alwaysVisible: !1, borderRadius:"3px", railBorderRadius:"0"
        })
}
...
function CustomJs() {
    $(".light_dark input").on("change", function() {
        ...
        $(".rtl_support input").on("change", function() {
            $(this).val(); $(this).is(":checked")?$("body").addClass("rtl"):$("body").removeClass("rtl")

        }),
        $(".ms_bar input").on("change", function() {
            $(this).val(); $(this).is(":checked")?$("body").addClass("ls-toggle-menu"):$("body").removeClass("ls-toggle-menu")
...
$.AdminAero.browser= {
    ...
    $(function() {
        "#dark"==location.hash&&($("body").addClass("theme-dark"), $("#darktheme").prop("checked",  !0), $(".menu ul.list a").each(function() {
            var e=$(this).attr("href")+"#dark"; $(this).attr("href", e)
        }))
    });
